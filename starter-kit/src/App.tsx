...
function App() {
  ...
  useEffect(() => {
    ...
    const fetchWeather = async () => {
      const url = `https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&daily=precipitation_probability_max,uv_index_max,weather_code&timezone=Asia%2FTokyo&forecast_days=1`;
